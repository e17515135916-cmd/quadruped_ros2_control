#!/usr/bin/env python3
"""
根据正确的URDF文件生成xacro文件（不包含足端）
"""

# 读取正确的URDF文件
with open('/home/dell/aperfect/carbot_ws/src/dog2_description/urdf/dog2.urdf', 'r') as f:
    urdf_content = f.read()
...
print("✓ xacro文件已重新生成（不包含足端）")
print("  - 基于正确的URDF文件")
print("  - 每条腿有4个link: l${leg_num}, l${leg_num}1, l${leg_num}11, l${leg_num}111, l${leg_num}1111")
print("  - 腿部位置已修复")
